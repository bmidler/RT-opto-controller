...
def SaveMetadata(cam_params, grabdata):
	...
	### Edits to un-break metadata save-out.

	try:
		full_folder_name = cam_params["ModVideoFolder"]
	except: # For backwards compatability.
		print("Use new writer file that un-breaks metadata save-out")
	...
	try:
		...
		# Save as CSV file.
		x.tofile(os.path.join(full_folder_name, "frametimes.csv"), sep=",")
